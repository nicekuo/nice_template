...
public class DownLoadTask {
	...
	private String downLoadPath = Environment.getExternalStorageDirectory().getPath() + "/jiche.apk";
	...
	private void showNotification() {
		nf = new Notification(R.drawable.ic_launcher, "jiche", System.currentTimeMillis());
