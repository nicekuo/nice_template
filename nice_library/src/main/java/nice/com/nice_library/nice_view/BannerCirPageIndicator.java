 ...
 */
public class BannerCirPageIndicator extends View implements ViewPager.OnPageChangeListener {
...
//	private int paddingBottom = dip2px(getContext(), 2);
    ...
    public BannerCirPageIndicator(Context context) {
        this(context, null);
    }

    public BannerCirPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void drawDots(Canvas canvas) {
        ...
        for (int i = 0; i < mCount; i++) {
            ...
            if (!(isAutoScroll && (i == 0 || i == mCount - 1))) {
