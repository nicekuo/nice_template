package nice.com.nice_library.widget.sweetalert;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    public static final int Upgrade_type = 6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewFlipper = (ViewFlipper) findViewById(R.id.vf_one_id);
    ...
    public SweetAlertDialog setContentText(String text) {
        mContentText = text;
        if (mContentTextView != null && mContentText != null&&!TextUtils.isEmpty(mContentText)) {
     ...
     */
    public SweetAlertDialog setCancelables(boolean flag) {
