package nice.com.nice_library.widget.progress;
...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        mColors = new int[1];
        mColors[0] = context.getResources().getColor(R.color.circular_progress_green);        
//        mColors[1] = context.getResources().getColor(R.color.circular_progress_yellow);
//        mColors[2] = context.getResources().getColor(R.color.circular_progress_green);
//        mColors[3] = context.getResources().getColor(R.color.circular_progress_blue);
    ...
    public void draw(Canvas canvas) {
        ...
        if (mModeAppearing) {
            mPaint.setColor(gradient(mColors[mCurrentColorIndex], mColors[0],//只让其展示一种颜色 0     多种颜色 mNextColorIndex
