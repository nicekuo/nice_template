package nice.com.nice_library.util.log;
...
public class SqlLog {
	 ...
	 * @return
	 */
	public static StringBuilder buildSqlLog(SQLiteDatabase db,
	 ...
	 * @return
	 */
	public static StringBuilder buildQuerySqlLog(SQLiteDatabase db,
	 ...
	 * @return
	 */
	public static StringBuilder buildDeleteSqlLog(SQLiteDatabase db,
	 ...
	 * @return
	 */
	public static StringBuilder buildSqlLog(final SQLiteDatabase db,
