...
public class ThreadUtils {
    ...
    private static ArrayDeque<Runnable> mWaitingImageDrawRunnables = new ArrayDeque<Runnable>();
...
//    }
            ...
            public void run() {
                if (serialUIExcutorPermitted) {
                    ...
                    if (r != null) {
                        ...
                        synchronized (mWaitingImageDrawRunnables) {
                            r = mWaitingImageDrawRunnables.pollFirst();
                        }
                        if (r != null) {
    ...
    public static void addOnUIImageSerialExecutor(Runnable r) {
        synchronized (mWaitingImageDrawRunnables) {
            mWaitingImageDrawRunnables.add(r);
        }
        startUISerialExecutor();
    }
}
